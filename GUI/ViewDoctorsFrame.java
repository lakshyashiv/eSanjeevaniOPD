...
public class ViewDoctorsFrame extends javax.swing.JFrame {
    ...
    public ViewDoctorsFrame() throws SQLException {
        initComponents();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ViewDoctorsFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private void viewAllDoctorDetails() throws SQLException {
